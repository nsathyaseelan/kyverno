...
"$pwd"/kind load docker-image ghcr.io/nsathyaseelan/kyverno:"$hash"
"$pwd"/kind load docker-image ghcr.io/nsathyaseelan/kyvernopre:"$hash"
...
kustomize edit set image ghcr.io/nsathyaseelan/kyverno:"$hash"
kustomize edit set image ghcr.io/nsathyaseelan/kyvernopre:"$hash"
